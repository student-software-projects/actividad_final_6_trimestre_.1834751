    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Editar <b>Conductor</b></h2></div>
                    <div class="col-sm-4">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $conductor->update($numero_cedula, $primer_nombre, $segundo_nombre, $apellidos, $direccion,$telefono,$ciudad,$id_conductor);
					if($res){
				...
				$datos_cliente=$conductor->single_record($id);
			?>
			<div class="row">
				<form method="post">
				<div class="col-md-6">
					...
					<input type="hidden" name="id_conductor" id="id_conductor" class='form-control' maxlength="100"   value="<?php echo $datos_cliente->id;?>">
				</div>
				<div class="col-md-6">
