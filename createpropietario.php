    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Propietario</b></h2></div>
                    <div class="col-sm-4">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $propietario->create($numero_cedula, $primer_nombre, $segundo_nombre, $apellidos, $telefono,$direccion,$ciudad);
					if($res){
